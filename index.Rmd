...
<embed src="files/Lozano-Isla2017.pdf" width="100%" height="600" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html">
...
```{r fbtmpl, fig.cap="Proceso de como crear una copia propia de la plantilla del libro de campo (fieldbook)"}
fig <- "fbtmpl"
gs %>% 
  read_sheet("fig") %>% 
  filter(figure == fig) %>% 
...
"Next Generation Label System Printer" es la mejor apliación web que encontré para generar etiquetas de forma eficiente y fácil, asi que les recomiendo pagar la suscripción cuando la necesiten. Para nuevos usuario los primero 15 días son gratis, asi que puedes probar la app.
...
> El diseño de las etiquetas esta basada en una configuración para ser impresa en gigantografía de 1x1 metro, siendo el precio sugerido por metro cuadrado de 4 a 6 dolares a todo color en impresión de alta calidad para que el codigo de barra pueda ser leido adecudamente.  
...
<embed src="files/etiquetas.pdf" width="100%" height="600" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html">
